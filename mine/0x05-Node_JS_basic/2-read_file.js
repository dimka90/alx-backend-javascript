  ...
  try {
    ...
    students.forEach((student) => {
      if (student.field !== 'field') { // Ignore the header
        ...
        // {
        //   console.log(counts[student.field])
        //   counts[student.field] = counts[student.field] + 1
        // }
        // else
        // {
        //   count[student.field] = 1;
        // }
        lists[student.field] = lists[student.field] ? [...lists[student.field], student.firstname] : [student.firstname];
      }
    });
